  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full max-w-[77.625rem] gap-1 py-8">
        {/* Top Row */}
        <div className="flex flex-col md:flex-row items-end justify-center gap-5 px-5 pt-5 pb-0 border border-border-light rounded-t-[1.25rem] overflow-hidden bg-background/20">
        ...
        {/* Bottom Row */}
        <div className="flex flex-col md:flex-row items-start gap-5 px-5 pt-0 pb-5 border border-border-light rounded-b-[1.25rem] overflow-hidden bg-background/20">
